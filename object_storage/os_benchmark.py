...
@click.option('--mb_per_file', help='MB of each object in COS', type=int)
@click.option('--number', help='number of files', type=int)
@click.option('--key_prefix', default='', help='COS key prefix')
@click.option('--outfile', default='cos_benchmark.write.output.pickle',
...
@click.option('--outfile', default='cos_benchmark.read.output.pickle',
              help='filename to save results in')
